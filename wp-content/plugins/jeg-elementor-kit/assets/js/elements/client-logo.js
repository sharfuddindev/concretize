    ...
    class n extends elementorModules.frontend.handlers.Base {
        ...
        loadCarousel() {
            ...
            Object.entries(o).forEach((([e, t]) => {
                "" === t.items && "" === t.margin || (r[t.breakpoint] = {}, i = t.breakpoint, "" !== t.items && (r[t.breakpoint].items = t.items), "" !== t.margin && (r[t.breakpoint].gutter = t.margin))
            ...
            tns(a), this.elements.$wrapper.find("button[data-action]").remove(), t.show_navigation || this.elements.$wrapper.find(".tns-controls").remove(), t.show_dots || this.elements.$wrapper.find(".tns-nav").remove()
        }
    }
